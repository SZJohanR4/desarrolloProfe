...
urlpatterns = [
    ...
    url(r'PaginaPrincipalAdmin/editarUsuarios/$', views.editarUsuario, name= 'editarUsuarios'),
    url(r'PaginaPrincipalAdmin/eliminarUsuarios/$', views.eliminarUsuario, name= 'eliminarUsuario'),
